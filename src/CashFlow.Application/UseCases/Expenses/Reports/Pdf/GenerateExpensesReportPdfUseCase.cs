...
using CashFlow.Application.UseCases.Expenses.Register.Reports.Pdf.Colors;
...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Davi José";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo_nike_principal.jpg", "Logo_nike_principal.jpg");
        
        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, Davi José");
